 ...
 * @author David Cosman
 * 
 *         Implements all the methods needed by algorithm computerPay.
 */
public class TicTacToe {
	 ...
	 * */
	public TicTacToe(int size, int to_win, int depth) {
		this.size = size;
		this.to_win = to_win;
	 ...
	 * Method Dictionary
	 * 
	 * Creates an object of type Dictionary.
	 * 
	 * @see Dictionary.java
	 * @return an empty Dictionary game tree
	 * */
	 ...
	 * 
	 * Represents the content of gameBoard as a string of 'X', 'O', or ' '; then
	 * it checks whether the string representing the gameBoard is in the
	 * configurations dictionary.
	 * 
	 * @param configurations
	 *            The dictionary being compared with the String representation
	 *            of gameBoard
	 * @return associated score if found in the dictionary, -1 if otherwise
	 * @see Dictionary.java.find(config)
	 * */
	public int repeatedConfig(Dictionary configurations) {
		return configurations.find(gameBoard_asString());
	}
	 ...
	 * 
	 * Represents the content of gameBoard as a string of 'X', 'O', or ' '; then
	 * it inserts the string and score as an entry in the Dictionary
	 * 
	 * @param configurations
	 *            The dictionary being compared with the String representation
	 *            of gameBoard
	 * @param score
	 * @see DictEntry.java; The score of the current entry
	 * */
	public void insertConfig(Dictionary configurations, int score) {
		// The entry going into the dictionary
		DictEntry entry = new DictEntry(gameBoard_asString(), score);
		try {
	 ...
	 * Method evalBoard
	 * 
	 * Evaluates and returns one of the score values
	 * 
	 * @see DictEntry.java
	 * 
	 * @return score value
