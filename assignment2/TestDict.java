public class TestDict {
	...
	/*
	 * * Test program for the Dictionary class.* This program WILL NOT COMPILE
	 * if your insert or remove* methods do not throw a DictionaryException.
	 */
	...
	public static void main(String[] args) {
		...
		if (collisions >= 6000) {
			...
			System.out.print("Too many collisions: " + collisions);
		} else
		{
			System.out.println("   Test 10 succeeded");
			System.out.print("   Number of collissions; " + collisions);
		}
	}
}
